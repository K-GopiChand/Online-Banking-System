...
<body>
    ...
    <div class="welcome-container">
        ...
        <p>Your trusted partner for all your banking needs. Let's get started!</p>
        ...
        <div class="card-container">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title cardtitlecolor">Login</h5>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title cardtitlecolor">Sign Up</h5>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title cardtitlecolor">Exit</h5>
                        <a href="Exit.jsp" class="btn btn-exit card-btn">Exit Bank Application</a>
                    </div>
                </div>
            </div>
        </div>
