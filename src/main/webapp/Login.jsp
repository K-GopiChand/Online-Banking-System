...
<body>
    ...
    <div class="container">
        ...
        <%String success = (String) session.getAttribute("customer");
        if (success != null) { %>
        ...
        <form class="mt-4 form" action="login" method="POST">
            <div class="form-group">
                <label for="email">Enter your ACCOUNT NUMBER:</label>
            ...
            <div style="display:flex; flex:1; font-family:calibri; justify-content:space-between; margin-top:10px;">
                ...
                <a href="ForgotPin.jsp" class="btn1 btn-link">Forgot PIN?</a>
