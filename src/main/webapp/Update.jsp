    ...
    <div class="update-card form">
        ...
        <form action="update" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="mail" placeholder="Enter new email">
            </div>

            <div class="form-group">
                <label for="phone">Update Phone Number:</label>
                <input type="tel" class="form-control" name="phone" placeholder="Enter new phone number">
            </div>
